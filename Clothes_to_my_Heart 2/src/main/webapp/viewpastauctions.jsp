...
<%
    ...
    try {
        ...
        String query = "SELECT Clothing_ID, Seller_Username, Clothing_Category, Brand, Color, Current_Bid_Value, Closing_Date_Time, Clothing_Description, isActive FROM clothing where Seller_Username = '" + username + "'";
...
%>
    <tr>
        ...
        <td><a href="auctionDetails.jsp?clothingID=<%= rs.getInt("Clothing_ID") %>"><%= rs.getString("Clothing_Category") %></a></td>
...
<a href="user_home.jsp"><button>Back to Home</button></a>
